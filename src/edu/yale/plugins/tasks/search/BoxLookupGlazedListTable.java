...
import org.archiviststoolkit.mydomain.DomainEventTableModel;
import org.archiviststoolkit.mydomain.DomainObject;
import org.archiviststoolkit.mydomain.DomainTableFormat;
import org.archiviststoolkit.mydomain.DomainFilterator;

public class BoxLookupGlazedListTable extends AlternatingRowColorTable {
	...
	public BoxLookupGlazedListTable() {
		super();
	}

	public BoxLookupGlazedListTable(Class clazz) {
		super();
		init(clazz, null);
	}

	public BoxLookupGlazedListTable(Class clazz, JTextField filterField) {
		super();
		init(clazz, filterField);
	}

	public BoxLookupGlazedListTable(Class clazz, JTextField filterField, DomainTableFormat tableFormat) {
		super();
